  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final larguraBloco = (larguraTela * 0.34).clamp(100.0, 150.0);
        final alturaBloco = larguraBloco * 1.4;
        final fontTitulo = (larguraTela * 0.07).clamp(22.0, 32.0);

        return Scaffold(
          drawer: const DrawerNav(),
          body: Column(
            children: [
              // Header fixo, fora da área que rola
              const Header(),
